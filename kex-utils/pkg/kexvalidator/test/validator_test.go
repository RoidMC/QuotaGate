...
import (
	...
	"github.com/roidmc/kex-utils/pkg/kexvalidator"
)
...
func TestEmailValidator(t *testing.T) {
	...
	ev := kexvalidator.NewEmailValidator(nil, nil)
...
func TestEmailValidatorBlacklist(t *testing.T) {
	ev := kexvalidator.NewEmailValidator(
...
func TestUsernameValidator(t *testing.T) {
	...
	uv := kexvalidator.NewUsernameValidator(3, 16, nil)
	for _, tt := range tests {
...
func TestUsernameValidatorReserved(t *testing.T) {
	uv := kexvalidator.NewUsernameValidator(3, 16, []string{"admin", "root", "system"})
...
func TestPasswordValidator(t *testing.T) {
	...
	pv := kexvalidator.NewPasswordValidator(8, 64)
	for _, tt := range tests {
...
func TestPasswordValidatorMaxLength(t *testing.T) {
	pv := kexvalidator.NewPasswordValidator(8, 10)
...
func TestValidateWithRegex(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			err := kexvalidator.ValidateWithRegex(tt.input, tt.pattern)
			if (err != nil) != tt.wantErr {

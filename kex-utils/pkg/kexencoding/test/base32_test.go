package kexencoding_test

import (
	"bytes"
	"testing"

	"github.com/roidmc/kex-utils/pkg/kexencoding"
)

func TestBase32EncodeDecode(t *testing.T) {
	original := []byte("hello world")
	encoded := kexencoding.Base32Encode(original)
	decoded, err := kexencoding.Base32Decode(encoded)
	if err != nil {
...
func TestBase32DecodeWithPadding(t *testing.T) {
	encoded := kexencoding.Base32Encode([]byte("test"))
	decoded, err := kexencoding.Base32Decode(encoded)
	if err != nil {
...
func TestBase32DecodeLowercase(t *testing.T) {
	encoded := kexencoding.Base32Encode([]byte("hello"))
	decoded, err := kexencoding.Base32Decode(encoded)
	if err != nil {
...
func TestBase32RoundTrip(t *testing.T) {
	...
	for _, tc := range tests {
		encoded := kexencoding.Base32Encode([]byte(tc))
		decoded, err := kexencoding.Base32Decode(encoded)
		if err != nil {
...
func TestBase32HexEncodeDecode(t *testing.T) {
	original := []byte("hello world")
	encoded := kexencoding.Base32HexEncode(original)
	decoded, err := kexencoding.Base32HexDecode(encoded)
	if err != nil {
...
func TestBase32HexRoundTrip(t *testing.T) {
	...
	for _, tc := range tests {
		encoded := kexencoding.Base32HexEncode([]byte(tc))
		decoded, err := kexencoding.Base32HexDecode(encoded)
		if err != nil {
...
func TestBase32DecodeInvalidInput(t *testing.T) {
	_, err := kexencoding.Base32Decode("!@#$%^&*")
	if err == nil {
...
func TestBase32HexDecodeInvalidInput(t *testing.T) {
	_, err := kexencoding.Base32HexDecode("!@#$%^&*")
	if err == nil {
...
func TestBase32EncodeEmpty(t *testing.T) {
	encoded := kexencoding.Base32Encode([]byte{})
	if encoded != "" {
...
func TestBase32HexEncodeEmpty(t *testing.T) {
	encoded := kexencoding.Base32HexEncode([]byte{})
	if encoded != "" {
		t.Errorf("expected empty string, got %q", encoded)
	}
	decoded, err := kexencoding.Base32HexDecode(encoded)
...
func TestBase32DecodeWithExplicitPadding(t *testing.T) {
	encoded := kexencoding.Base32Encode([]byte("a"))
	decoded, err := kexencoding.Base32Decode(encoded)
	if err != nil {

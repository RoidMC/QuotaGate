...
func TestGenerateSelfSignedCert(t *testing.T) {
	...
	cert, err := kextls.GenerateSelfSignedCert(tmpDir, "test-service")
	if err != nil {
...
func TestGenerateSelfSignedCertEmptyServiceName(t *testing.T) {
	...
	cert, err := kextls.GenerateSelfSignedCert(tmpDir, "")
	if err != nil {
...
func TestFileExists(t *testing.T) {
	...
	if !kextls.FileExists(existingFile) {
		t.Error("FileExists returned false for existing file")
	}

	if kextls.FileExists(filepath.Join(tmpDir, "not-exists.txt")) {

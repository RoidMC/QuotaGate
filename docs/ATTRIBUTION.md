# QuotaGate Attribution Requirements

## Overview

This document outlines **permissible attribution requirements** for the QuotaGate under MPL-2.0. Compliance with these requirements is a condition of using the QuotaGate.  
...
Any application, game, or software product that incorporates or uses the QuotaGate must include the following attribution in at least one of the following locations:
...
If you choose to display the QuotaGate Logo (the “Logo”) in your product, you must strictly comply with the following terms:

3.1 Basic Requirements

- Use ​​only the standard Logo​​ (PNG/SVG) from the official QuotaGate [website](www.roidmc.com) or authorized channels. No modifications allowed.
...
- The logo is not used in a way that suggests endorsement of your product by QuotaGate creators
...
- Feature the Logo in third-party content (blogs, tutorials, videos) to market your product (e.g., “Powered by QuotaGate - download here”).
...
- Combine the Logo with other brands/logos as a joint identifier (e.g., “YourApp × QuotaGate”).

4. Misuse in Derivatives or Third-Party Platforms
- Use the Logo as a primary identifier for plugins, modules, or extensions based on QuotaGate.
...
Technical limitations exemptions for ​​visual text attribution​​ (e.g., "Powered by QuotaGate") require:

- You obtain ​​prior written approval​​ from QuotaGate copyright holders;
...
Note​​: This exemption ​​only waives the requirement to add visual text​​ in your product’s UI. MPL-2.0 obligations for the QuotaGate code (e.g., retaining copyright notices) still apply.
...
Exemptions to these attribution requirements may be granted with explicit written permission from the copyright holders of the QuotaGate.
...
If you ​​materially breach​​ your obligations under this document (e.g., deleting the original LICENSE file, altering copyright notices), and fail to cure the breach within ​​30 days​​ of receiving written notice, the QuotaGate Copyright Holder may:

- Terminate your license to use the QuotaGate;
...
By using the QuotaGate, you acknowledge and agree to these attribution requirements. Any disputes arising under this document shall first be resolved through friendly consultation.

---

© [RoidMC Studios](https://www.roidmc.com) | [MPL-2.0 License](../LICENSE) | Last Updated: 2026/6/27

Enforcement Effective​​: 2026/6/27 (including the revised Logo Usage section and contact information).
